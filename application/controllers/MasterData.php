...
class MasterData extends CI_Controller
{
    ...
    public function list_petugas()
    {
        ...
        foreach ($data as $petugas) {
            ...
            // echo '<td>**********</td>'; (utk menyembunyikan password)
            echo '<td>' . $petugas->DESKRIPSI. '</td>';
            echo '<td>' . $petugas->NAMA_PETUGAS . '</td>';
            echo '<td>
                <a href="#" data-toggle="modal" data-target="#modalEdit' . $petugas->ID_PETUGAS . '" class="btn btn-sm btn-danger" data-popup="tooltip" data-placement="top" title="Edit Data">Edit</a>
                <a href="' . base_url('masterdata/petugas_del/') .  $petugas->ID_PETUGAS . '" class="btn btn-sm btn-primary tombol-hapus">Hapus</a>
                </td>';
            echo '</tr>';
            echo "<script>
    ...
    public function list_siswa()
    {
        ...
        foreach ($data as $siswa) {
            ...
            echo '<td>
                <a href="#" data-toggle="modal" data-target="#modalEdit' . $siswa->NISN . '" class="btn btn-sm btn-danger" data-popup="tooltip" data-placement="top" title="Edit Data">Edit</a>
                <a href="' . base_url('masterdata/siswa_del/') .  $siswa->NISN . '" class="btn btn-sm btn-primary tombol-hapus"  id="delete" name="delete">Hapus</a>
                </td>';
            echo '</tr>';
            echo "<script>
                     $('.tombol-hapus').on('click', function(e) {
    ...
    {
        $this->form_validation->set_rules('NISN', 'NISN', 'required|trim|min_length[10]|numeric');
        $this->form_validation->set_rules('NIS', 'NIS', 'required|trim|min_length[8]|numeric');
        $this->form_validation->set_rules('nama', 'Nama', 'required|trim');
        $this->form_validation->set_rules('kelas_id', 'Kelas', 'required|trim');
        $this->form_validation->set_rules('spp_id', 'Tahun Ajaran', 'required|trim');
        $this->form_validation->set_rules('alamat', 'Alamat', 'required|trim');
    ...
    public function list_spp()
    {
        ...
        foreach ($data as $spp) {
            ...
            echo '<td>
                <a href="#" data-toggle="modal" data-target="#modalEdit' . $spp->ID_SPP . '" class="btn btn-sm btn-danger" data-popup="tooltip" data-placement="top" title="Edit Data">Edit</a>
                <a href="' . base_url('masterdata/spp_del/') .  $spp->ID_SPP . '" class="btn btn-sm btn-primary tombol-hapus"  id="delete" name="delete">Hapus</a>
                </td>';
            echo '</tr>';
             echo "<script>
                     $('.tombol-hapus').on('click', function(e) {
