        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg">
                    ...
                    <div class="card-title mt-3 ml-2 col-md-12 d-flex justify-content-between">
                        <a href="<?= site_url('masterdata/add_siswa') ?>" class="btn btn-primary mb-2">Tambah Data Siswa</a>
                        <!-- cari siswa -->
                        <!-- <form action="<?= base_url('masterdata/list_siswa') ?>">
                            <input type="text" name="keyword" placeholder="Ketikkan nama siswa">
