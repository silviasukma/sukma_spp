...
<aside class="main-sidebar sidebar bg-dark elevation-4">
    <!-- Brand Logo -->
               ...
               with font-awesome or any other icon font library -->
                ...
                <?php if ($title == 'Home') : ?>
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <?php endif ?>
                        <i class="fas fa-chalkboard nav-icon fas"></i>
                        <p>
                            Home
                        </p>
                        </a>
                                    ...
                                    <?php elseif ($this->session->userdata('level') == 'Petugas') : ?>
                                        ...
                                        <?php if ($title == 'Entri Transaksi Pembayaran') : ?>
                                            ...
                                            <?php else : ?>
                                                ...
                                                <li class="nav-item">
                                                    <a href="<?= base_url('auth/logout') ?>" class="nav-link text-white logout">
