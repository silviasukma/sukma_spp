        ...
        <div class="container-fluid">
            ...
            <?php if ($this->session->userdata('level') == 'Admin') : ?>
                <div class="row">
                    ...
                    <div class="col-lg-3 col-6">
                        <!-- small box -->
                        <div class="small-box bg-blue" style="height: 142px;">
                            <div class="inner">
...
<div class="card text-center">
    ...
    <div class="card-header bg-primary text-white">
      ...
      <marquee> <h2><b>Selamat Anda Telah Bergabung Di Aplikasi Pembayaran SPP</b></h2></marquee>
    </div>
    <div class="card-body">
...
<div class=" card text-center">
    ...
    <h1><i class="fa fa-user-circle"></i></h1>
       ...
       <h2><b> Rajin pangkal pandai hemat pangkal kaya </h2></b>
        </div>
    <link rel="stylesheet" href="font-awesome/css/font-awesome.min.css" />
</div>
</div>
